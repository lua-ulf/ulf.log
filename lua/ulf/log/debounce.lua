...
---@class ulf.log.Debounce
---@field timer uv_timer_t
---@field fn function
---@field args table
---@field wait number
---@field leading? boolean
---@overload fun(fn: function, wait: number, leading?: boolean): ulf.log.Debounce
local Debounce = {}
...
return setmetatable(Debounce --[[@as table]], {
	__call = Debounce.new,
})
